...
(function ($, window, document) {
            ...
            default:
                ...
                links.each(function(){
                    if(!found){
                        ...
                        //if char code and text match case-insensitive then set current
                        if(text && text.substring(0,1).toLowerCase() == char){
                            found = true;
                            _setCurrent($this.parent(),$dk);
                        }
                    }
                });
    ...
    $(function () {
        ...
        //fix bug in dropkick so that clicks outside close dropdown
